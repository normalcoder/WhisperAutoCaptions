...
actor WhisperContext {
    ...
    func getTranscription() -> [(Int64, Int64, String)] {
        var transcription: [(Int64, Int64, String)] = []
        for i in 0..<whisper_full_n_segments(context) {
            
            let startTime = whisper_full_get_segment_t0(context, i)
            let endTime = whisper_full_get_segment_t1(context, i)
            transcription.append((startTime*10, endTime*10, String.init(cString: whisper_full_get_segment_text(context, i))))
        }
